...
export const createUserSchema = z.object({
    ...
    phone: z.string().regex(phoneRegexTH, { message: "Must be a valid TH phone number" }),
...
export const loginUserSchema = registerUserSchema.omit({
    ...
    phone: z.string().regex(phoneRegexTH, { message: "Must be a valid TH phone number" }).optional(),
